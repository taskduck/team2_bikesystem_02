...
pluralCaseList.push( {plural: "approvals", pascal: "Approval"} )

pluralCaseList.push( {plural: "reservations", pascal: "Reservation"} )

pluralCaseList.push( {plural: "points", pascal: "Point"} )

pluralCaseList.push( {plural: "managements", pascal: "Management"} )


pluralCaseList.push( {plural: "reservationDashboards", pascal: "ReservationDashboard"} )
